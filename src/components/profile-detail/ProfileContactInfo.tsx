        ...
        <div className="flex items-center gap-4 text-base sm:text-lg">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-full flex items-center gap-1 transition-colors text-sm"
            >
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-full flex items-center gap-1 transition-colors text-sm"
            >
